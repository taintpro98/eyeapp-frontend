...
export function SocialLoginButtons() {
  ...
  const handleFacebookClick = () => {
    loginWithSocial('facebook', { email: 'demo@facebook.com', name: 'Facebook Demo User' })
    navigate('/app/dashboard')
  }
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-surface-border bg-[#1877F2] px-4 py-2.5 text-sm font-medium text-white shadow-card transition-colors hover:bg-[#166FE5]"
      >
