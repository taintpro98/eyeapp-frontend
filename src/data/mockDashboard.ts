export const mockSignals = [
  { id: '1', symbol: 'VNM', type: 'Buy', strength: 'Strong', time: '2 min ago', market: 'stocks' },
  { id: '2', symbol: 'VCB', type: 'Sell', strength: 'Medium', time: '5 min ago', market: 'stocks' },
  { id: '3', symbol: 'FPT', type: 'Buy', strength: 'Weak', time: '12 min ago', market: 'stocks' },
